...
public class DSATestJUnit {
	...
	public void test_no_path() {
		...
		assertEquals("No valid path exists", value, false);
	}

	@Test
	public void test_right_move() {
		DSA dsa = new DSA(size);
		assertEquals(dsa.findFirstMove(getOpenMap(), size - 3, size - 5, size - 1, size - 5),
				(size - 2) + ((size - 5) * size));
	}
	...
	public void test_down_move() {
		DSA dsa = new DSA(size);
		assertEquals(dsa.findFirstMove(getOpenMap(), size - 3, size - 5, size - 3, size - 3),
				(size - 3) + ((size - 4) * size));
	}
	...
	public void test_left_move() {
		DSA dsa = new DSA(size);
		assertEquals(dsa.findFirstMove(getOpenMap(), size - 3, size - 5, size - 5, size - 5),
				(size - 4) + ((size - 5) * size));
	}
	...
	public void test_up_move() {
		DSA dsa = new DSA(size);
		assertEquals(dsa.findFirstMove(getOpenMap(), size - 3, size - 5, size - 3, size - 7),
				(size - 3) + ((size - 6) * size));
	}
	...
	public void test_top_right_diagonal_move() {
		DSA dsa = new DSA(size);
		assertEquals(dsa.findFirstMove(getOpenMap(), size - 3, size - 5, size - 1, size - 7),
				(size - 2) + ((size - 6) * size));
	}
	...
	public void test_top_left_diagonal_move() {
		DSA dsa = new DSA(size);
		assertEquals(dsa.findFirstMove(getOpenMap(), size - 3, size - 5, size - 5, size - 7),
				(size - 4) + ((size - 6) * size));
	}
	...
	public void test_bottom_right_diagonal_move() {
		DSA dsa = new DSA(size);
		assertEquals(dsa.findFirstMove(getOpenMap(), size - 3, size - 5, size - 1, size - 3),
				(size - 2) + ((size - 4) * size));
	}
	...
	public void test_bottom_left_diagonal_move() {
		DSA dsa = new DSA(size);
		assertEquals(dsa.findFirstMove(getOpenMap(), size - 3, size - 5, size - 5, size - 3),
				(size - 4) + ((size - 4) * size));
	}
